...
float3 PBRdir(float3 albedo, float3 normal, float metallic, float roughness, float ao, float3 direction, float3 camPos, float3 worldPos, float shadow) 
{
    float PI = 3.14159265359;
...
float3 PBRpoint(float3 albedo, float3 normal, float metallic, float roughness, float ao, float3 position, float3 camPos, float3 worldPos, float shadow)
{
    float PI = 3.14159265359;
    float3 N = normalize(normal);
    float3 V = normalize(camPos - worldPos);
